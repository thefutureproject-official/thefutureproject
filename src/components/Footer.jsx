                        ...
                        <div className='flex'>
                            ...
                            <form class="max-w-sm mx-auto mt-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="email-address-icon" class="bg-gray-50 border  text-gray-900 text-sm rounded-lg focus:outline-slate-600 block w-full ps-10 p-2.5  dark:bg-gray-700  dark:placeholder-gray-400 dark:text-white " placeholder="enter gmail to invite" />
                                </div>
                            </form>
