        ...
        <>
            <div
                ...
                <motion.div
                    ...
                    className='rounded-md w-80 h-fit mt-10 p-9 flex flex-col text-white bg-gradient-to-r from-[#030014] via-[#2a2542] to-[#030014]'>
                    ...
                    <div>
                        <button className='bg-transparent border py-2 px-4 flex mt-4 gap-2  w-full '>
